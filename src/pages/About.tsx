        ...
        <Stack className="align-items-center">
            ...
            <Stack className="px-3">
                <Stack gap={3} className="align-items-center text-center">
                    ...
                    <p>
                        Dream your road trip with the perfect travel van.
                        Take the opportunity to make your dream itenireray. (Imagination without limits 😉) </p>
                      <p>  Click the button below to choose a van.
                        On the next screen you can choose your dream route.
                    </p>
